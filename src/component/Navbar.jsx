...
const Navbar = () => {
  ...
  const LinksNav = (
    <>
      <li className={`${pathName === "/" && "border-b-4 pb-1"}`}>
        <Link href={"/"}>Home</Link>
      </li>
      <li className={`${pathName === "/allProperty" && "border-b-4 pb-1"}`}>
        <Link href={"/allProperty"}>All Properties</Link>
      </li>
    </>
  );
  ...
  const LinksProfile = (
    <>
      <li
        className={`${pathName === `/deshboard/${session?.user?.role}` && "border-b-4 pb-1"}`}
      >
        <Link href={`/deshboard/${session?.user?.role}`}>Dashboard</Link>
      </li>
    </>
  );
                  ...
                  <Dropdown.Popover>
                    ...
                    >
                      ...
                      <Dropdown.Item textValue="All Properties">
                        <Link href="/allProperty" className="w-full block py-1">
                          All Properties
                        </Link>
                      </Dropdown.Item>
                      ...
                      {session && (
                        <>
                          ...
                          <Dropdown.Item variant="danger" textValue="Sign Out">
                            <button
                              onClick={logOutHanle}
                              className="w-full text-left text-red-500 font-medium py-1"
                            >
                              Sign Out
                            </button>
                          </Dropdown.Item>
